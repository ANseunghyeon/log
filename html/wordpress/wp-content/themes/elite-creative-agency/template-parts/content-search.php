...
?>
 <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
	...
	<ul class="meta-info">
		...
		<li class="comments-quantity"><a href="<?php echo esc_url(get_comments_link( $post->ID )); ?>"><i class="fa fa-wechat"></i> (<?php echo get_comments_number($post->ID); ?>) <?php esc_html_e('Comments','elite-creative-agency'); ?></a></li>
		<li class="posted-by"><i class="fa  fa-user"></i> <?php esc_html_e('By','elite-creative-agency'); ?> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php esc_html(the_author()); ?></a></li>
